...
TASC lives inside the `fabric-accessible-graphics` repo alongside TACT. It uses the same Python virtual environment.
...
# Install TASC in editable mode (already done if you followed initial setup)
